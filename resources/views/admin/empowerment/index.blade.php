...
@php
    $statusOptions = $statusOptions ?? \App\Models\Empowerment::statuses();
@endphp
...
<div class="card shadow-sm border-0">
    <div class="card-body table-responsive">
        <form method="GET" class="row g-2 align-items-end mb-3">
            ...
            @if(request('status'))
                <div class="col-auto">
                    <a href="{{ route('admin.empowerment.index') }}" class="btn btn-sm btn-link text-decoration-none">Atur Ulang</a>
                </div>
            @endif
        </form>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-flex gap-2">
                        <a href="{{ route('admin.empowerment.edit', $item->id) }}" class="btn btn-sm btn-outline-secondary">Ubah</a>
