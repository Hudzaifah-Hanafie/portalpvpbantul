...
@php
    $statusOptions = $statusOptions ?? \App\Models\InfographicYear::statuses();
@endphp
...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form method="GET" class="row g-2 align-items-end mb-3">
            ...
            @if(request('status'))
                <div class="col-auto">
                    <a href="{{ route('admin.infographic-year.index') }}" class="btn btn-sm btn-link text-decoration-none">Atur Ulang</a>
                </div>
            @endif
        </form>
                ...
                @forelse($years as $year)
                    <tr>
                        ...
                        <td class="text-nowrap">
                            ...
                            <span class="badge {{ $year->is_active ? 'bg-success' : 'bg-dark' }}">{{ $year->is_active ? 'Aktif' : 'Nonaktif' }}</span>
                        </td>
                        <td>
