...
@php
    $statusOptions = $statusOptions ?? \App\Models\CertificationScheme::statuses();
@endphp
...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form method="GET" class="row g-2 align-items-end mb-3">
            ...
            @if(request('status'))
                <div class="col-auto">
                    <a href="{{ route('admin.certification-scheme.index') }}" class="btn btn-sm btn-link text-decoration-none">Atur Ulang</a>
                </div>
            @endif
        </form>
